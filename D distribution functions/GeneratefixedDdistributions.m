...
if input.fitlocerror == 0 && sum(fixedparameters(i,2:5)>-1) == 4
    
    Dfixed(i,j).dist = DDistributiongenerator(fixedparameters(i,2),fixedparameters(i,3),fixedparameters(i,4),fixedparameters(i,5),rangeD,fx,fy,maxDindtracking,input,j)';
